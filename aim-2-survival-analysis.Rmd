...
gtsave_extra(gt(as.data.frame(t(expanded_df)),rownames_to_stub = TRUE), vwidth = 800, vheight = 6000,file.path("tables", 
                                paste0("Summary table for selected features.png")), expand = 10)
```
